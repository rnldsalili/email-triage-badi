...
**CRITICAL**: If no design system exists, do not create one yet. STOP and call the `question` tool to clarify. Understand the preferred location and structure first.

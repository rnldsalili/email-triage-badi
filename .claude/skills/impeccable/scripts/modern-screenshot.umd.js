(function (y, v) {
  ...
  function ut(e) {
    var r;
    const t =
      (r = e == null ? void 0 : e.createElement) == null ? void 0 : r.call(e, "canvas");
    return (
...
`);
  ...
  function $t(e, t) {
    const r = [];
    return (
      e.replace(ke, (n, i, a) => (r.push([a, ue(a, t)]), n)), r.filter(([n]) => !re(n))
    );
  }
  function Lt(e) {
...
`)
          ...
          const c = Array.from(r.styleSheets).filter((f) => {
              try {
                ...
                return (
                  t.log.warn(`Error while reading CSS rules from ${f.href}`, h), !1
                );
              }
            }),
